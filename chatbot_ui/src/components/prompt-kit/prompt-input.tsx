...
function PromptInput({
  ...
  return (
    <TooltipProvider>
      ...
      >
        {/* biome-ignore lint/a11y/useKeyWithClickEvents: keyboard users focus the inner textarea directly */}
        {/* biome-ignore lint/a11y/noStaticElementInteractions: container click focuses the textarea */}
        <div
          onClick={handleClick}
          className={cn(
